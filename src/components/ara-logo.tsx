...
export function AraLogo({ className = '', width = 40, height = 40 }: AraLogoProps) {
  return (
    <svg 
      width={width} 
      height={height} 
    ...
    >
      ...
      <defs>
        <radialGradient id="bgGradient" cx="0.5" cy="0.5" r="0.5">
          <stop offset="0%" stopColor="#0A1F3D" stopOpacity="0.9"/>
        ...
        <linearGradient id="ribbonGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="50%" stopColor="#18A0A0"/>
        ...
        <linearGradient id="shadowGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#0A1F3D" stopOpacity="0.6"/>
          <stop offset="100%" stopColor="#0A1F3D" stopOpacity="0.2"/>
        </linearGradient>
      </defs>
      
      {/* Background */}
      <circle cx="60" cy="60" r="58" fill="url(#bgGradient)" stroke="#1E5BFF" strokeWidth="2"/>
