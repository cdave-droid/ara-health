      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-inter font-bold text-ara-navy mb-6 md:mb-12 leading-tight">
            Let's Build a New <span className="bg-gradient-to-r from-ara-blue via-ara-teal to-ara-blue-light bg-clip-text text-transparent">Medical System Together</span>
          </h2>
        </motion.div>
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            <p className="text-gray-600">
              We're currently developing our survey. Please contact us directly to share your feedback about advance-care planning.
            </p>
            <Button
              onClick={() => {
