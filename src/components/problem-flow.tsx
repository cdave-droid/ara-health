  ...
  >
    ...
    >
      ...
      <p className="text-sm text-gray-600 max-w-md">
        Discover how we&apos;re connecting the dots to transform healthcare
        decision-making
      </p>
    </motion.div>
  </motion.div>
  ...
  const problems = [
    {
      ...
      description:
        "Clinicians face critical decisions during cardiac arrest without access to patient preferences, often leading to unnecessary resuscitation.",
    ...
    },
    {
      ...
      description:
        "DNR forms and advance directives are frequently misplaced in filing cabinets, family inboxes, or buried in patient portals.",
    ...
    },
    {
      title: "High Costs",
      description:
        "Each unnecessary resuscitation costs $30-50,000 per patient, leading to patients dying without dignity or respect for their wishes.",
